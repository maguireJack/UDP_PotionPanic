...
namespace GDLibrary.Actors
{
    ...
    public class Actor2D : Actor
    {
        ...
        {
            //deep-copy
            return new Actor2D(this.ID, //value type so this is deep copy
                this.ActorType, // value type so this is deep copy
                this.StatusType, // value type so this is deep copy
                this.transform2D.Clone() as Transform2D); // reference type so we call its Clone to get a deep copy
        }
